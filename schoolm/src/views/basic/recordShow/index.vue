<template>
  <div class="recordShow">
    ...
    <el-table :data="tableData" border style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column fixed prop="blacklistId" label="id" width="100" sortable align="center"></el-table-column>
      <el-table-column prop="userId" label="用户编号" width="250" align="center"></el-table-column>

      <el-table-column prop="name" label="姓名" width="200" sortable align="center"></el-table-column>
      <el-table-column prop="grade" label="年级" width="200" align="center"></el-table-column>
      <el-table-column prop="prof" label="专业" width="250" align="center"></el-table-column>
      <el-table-column prop="addTime" label="添加时间" width="200" sortable align="center"></el-table-column>
      <el-table-column prop="description" label="备注" width="200" align="center"></el-table-column>
    ...
    <el-dialog title="借出信息" v-model="dialogFormVisible" width="50%">
      <el-form :model="form" size="medium" :rules="rules" ref="form">
        <el-form-item label="ID" :label-width="formLabelWidth">
          <el-input v-model="form.blacklistId" autocomplete="off" disabled></el-input>
        </el-form-item>
        ...
        <el-form-item label="专业" :label-width="formLabelWidth">
          <el-input v-model="form.prof" autocomplete="off"></el-input>
        </el-form-item>
  ...
  methods: {
    itemexport() { //导出
      this.$http.get("/record/export", {
        ...
        fileDownload(res, '黑名单信息_' + new Date().toLocaleString() + '.xlsx')
      }).catch(() => {
