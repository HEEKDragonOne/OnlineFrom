  ...
  <el-container
    ...
    <el-aside :width=" sideWidth +'px'" style="background-color: rgb(238, 241, 246);height: 100%">
      <el-scrollbar style="background-color: rgb(48,65,86)">
        <!--       default-openeds  :default-openeds="['2']"默认展开 -->
        <el-menu style="height: 100%;"
          ...
          <div style="height: 60px;line-height: 60px; text-align: center">
            ...
            <b style="color: white" v-show="logoTextShow">墨水记忆-在线报名系统</b>
          </div>
          ...
          <div v-for="item in menuData" :key="item.id+''">
            <el-sub-menu :index="item.id+''">
              <template #title>
                <el-icon>
                  <component :is="item.menuIco"></component>
                </el-icon>
              ...
              <div v-for="subItem in item.children" :key="subItem.id+ ''">
                <el-menu-item :index="subItem.menuPath">
                  <el-icon>
                    <component :is="subItem.menuIco"></component>
                  </el-icon>
                  {{ subItem.menuName }}
                </el-menu-item>
              </div>
    ...
    <el-container>
      <el-header style="text-align: right; font-size: 12px;border-bottom: 1px solid #ccc;">
        ...
        <div style="flex: 1;font-size: 18px;" class="hiddennav">
          <el-icon>
            <component style="cursor: pointer;" :is="collapseBtnClass" @click="collepse"></component>
          </el-icon>
        </div>
        <!-- 面包屑导航 -->
