<template>
  <div class="intemShow">
    ...
    <div style="padding: 10px 0">
      ...
      <el-upload action="http://127.0.0.1:8081/userRole/import" style="display: inline-block;margin-left: 5px"
                 :on-success="successimport" :on-error="errimport" :show-file-list="false">
    ...
    <el-table :data="tableData" border style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column fixed="right" label="操作" width="300" align="center">
        <template v-slot="scope">
          <el-button type="info" size="default" @click="selectMenu(scope.row.id)">权限分配
            <el-icon>
              <Grid/>
            </el-icon>
          </el-button>
